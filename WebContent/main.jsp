	...
	<body class="layout-fixed">
		...
		<div class="nav-wrapper">
			<ul class="nav navbar-nav navbar-right">
				<li>
					<a>
						<span class="user-name-csdc">欢迎登录：${sessionScope.sess_user.username}</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<li class="dropdown">
				<a class="menu-icons" href="user/loginout.do" title="注销"   data-width="780" data-height="500">
						<em class="fa fa-gear main-op" style="font-size:13px">注销</em>
					</a>
