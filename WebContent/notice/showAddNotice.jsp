...
<html>
	...
	<body>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
	     ...
	     <form action="notice/noticeAdd.do" id="noticeForm">
		 <!-- 请求异常错误  -->
			    ...
			    <td>
				  ...
				  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
					    <tr><td class="font3 fftd">
					             ...
					             提交人：   <input type="text" name="user_name" readonly="readonly" value="${sessionScope.sess_user.username}"/>
						...
						<tr><td class="font3 fftd">
								<input type="button" onclick="submit_notice()" value="添加">
