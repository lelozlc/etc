...
function loadMenu(){
	...
	+'"childs": [{"id": "111","name": "用户查询","icon": "","url": "user/userSeacher.do?currentPage=1","parentId": "11",'
	...
	+'"childs": [{"id": "121","name": "部门查询","icon": "","url": "dept/deptSearch.do?currentPage=1","parentId": "12",'
	...
	+'"childs": [{"id": "141","name": "职位查询","icon": "","url": "job/jobSearch.do?currentPage=1","parentId": "14",'
	...
	+'"childs": [{"id": "151","name": "员工查询","icon": "","url": "employee/employeeSearch.do?currentPage=1&job.id=0&name=&cardId=&sex=0&phone=&dept.id=0","parentId": "15",'
	...
	+'"childs": [{"id": "161","name": "公告查询","icon": "","url": "notice/noticeSearch.do?currentPage=1","parentId": "16",'
	...
	+'"childs": [{"id": "171","name": "文档查询","icon": "","url": "document/documentSearch.do?currentPage=1","parentId": "17",'
